...
⠀
#### DONOTGET
###### This setting follows the same format as custom_values. These are the itemids of items you do not want to trade for
⠀
#### keepimages
###### Whether the bot shouldn't delete the autogenerated images it does when it queues
⠀
#### DONOTTRADE
###### This setting follows the same format as custom_values. These are the itemids of items you **DO NOT** want the bot to trade
⠀
#### getridoffast
###### This setting follows the same format as custom_values. These are the itemids of items you **ONLY** want the bot to trade
